...
export function PostDetail({ post, deleteMutation, updateMutation }) {
  ...
  return (
    <>
      ...
      <div > <button onClick={() => deleteMutation.mutate(post.id)}>Delete</button> <button>Update title</button></div>
      ...
      <div>
        <div>
          ...
          <button onClick={() => updateMutation.mutate(post.id)}>Update title</button></div>
        {updateMutation.isPending && (
          <p className="loading">Update the post</p>
        )}
